                                                                    ...
                                                                    <tr key={orderData.id}>
                                                                        ...
                                                                        <td><td>
                                                                            {(orderData.haveShipping === true) ? (
                                                                                <span>${orderData.precio_total + orderData.precio_envio}</span>
                                                                            ) : (
                                                                        ...
                                                                        <td>
                                                                            {(orderData.haveShipping === false) ? (
                                                                                <div>
                                                                                    ...
                                                                                    <input onChange={(e) => handleShipping(e.target.value)} value={envio} style={{ width: '7rem', marginLeft: '5px' }} type="text" id='envio' />
                                                                                </div>
                                                                            ) : (
